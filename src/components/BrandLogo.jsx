...
export default function BrandLogo({ className = "" }) {
  return (
    <div className={className}>
      {logoIcons.small}
      <p style={logoStyle.lightSmall}>Joblify Logo</p>
    </div>
  );
}
...
const logoStyle = {
  lightSmall: {
    fontFamily: logoAttri.font,
    color: logoAttri.light,
    fonntSize: logoAttri.smallFs,
  },
  lightRegular: {
    fontFamily: logoAttri.font,
    color: logoAttri.light,
    fonntSize: logoAttri.regularFs,
  },
  lightLarge: {
    fontFamily: logoAttri.font,
    color: logoAttri.light,
    fonntSize: logoAttri.largeFs,
  },
  darkSmall: {
    fontFamily: logoAttri.font,
    color: logoAttri.dark,
    fonntSize: logoAttri.smallFs,
  },
  darkRegular: {
    fontFamily: logoAttri.font,
  ...
  darkLarge: {
    fontFamilt: logoAttri.font,
    color: logoAttri.dark,
    fontSize: logoAttri.largeFs
  }
